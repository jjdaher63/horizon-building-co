...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription:
      "A bold modern residential project in the heart of West Hollywood featuring a striking mixed-material facade of dark metal, concrete, and wood. The design balances dramatic architectural expression with refined interior living spaces. Floor-to-ceiling glazing, rooftop terraces, and high-end finishes create a sophisticated urban residence that stands out on one of WeHo's premier streets.",
    highlights: [
    ...
    coverAlt: "Modern residential building with dark metal and concrete facade in West Hollywood",
    photos: Array.from({ length: 15 }, (_, i) => ({
      src: `/images/projects/westmount/${i + 1}.webp`,
      alt: `Westmount West Hollywood residence — photo ${i + 1}`,
    })),
  },
  {
