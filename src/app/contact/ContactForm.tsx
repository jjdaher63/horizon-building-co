...
export default function ContactForm() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    formData.append("access_key", "55879f57-1da7-4797-9e7d-ecaee96dee49");
    formData.append("subject", "New Consultation Request — Horizon Building Co");
    formData.append("from_name", "Horizon Building Co Website");
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    name="project_type"
                    className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded text-foreground focus:outline-none focus:border-gold"
                  >
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full px-8 py-4 bg-gold text-gray-900 font-semibold rounded hover:bg-gold-light transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
